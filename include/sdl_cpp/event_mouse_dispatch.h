...
namespace sdl
{
	class event_mouse_dispatch : public mouse_motion_event_handler,
	...
	public:
		...
		void add_mouse_motion_event_handler(
			mouse_motion_event_handler& handler);
		void remove_mouse_motion_event_handler(
			mouse_motion_event_handler& handler);
		void add_mouse_button_event_handler(
			mouse_button_event_handler& handler);
		void remove_mouse_button_event_handler(
			mouse_button_event_handler& handler);
		void add_mouse_wheel_event_handler(mouse_wheel_event_handler& handler);
		void remove_mouse_wheel_event_handler(
