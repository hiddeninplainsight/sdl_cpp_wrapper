...
namespace sdl
{
	...
	void mouse_state::mouse_motion_event(Uint32 mouse_id, Uint32 button_state,
	...
	void mouse_state::mouse_button_pressed_event(Uint32 mouse_id,
												 mouse_button button,
	...
	void mouse_state::mouse_button_released_event(Uint32 mouse_id,
												  mouse_button button,
												  Uint8 clicks, Sint32 x,
												  Sint32 y)
	{
	...
	mouse_button_state mouse_state::button_press(mouse_button button,
												 bool clear)
	{
	...
	mouse_button_state mouse_state::button_release(mouse_button button,
												   bool clear)
	{
