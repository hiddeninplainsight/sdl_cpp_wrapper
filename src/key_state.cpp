...
namespace sdl
{
	...
	key_state::~key_state() { remove_from_events_system(); }
	...
	void key_state::key_down_event(SDL_Keycode, Uint16) { down = true; }
	void key_state::key_up_event(SDL_Keycode, Uint16) { down = false; }
