...
namespace sdl {
	...
	interface mouse_button_event_handler {
		+{abstract}  void mouse_button_pressed_event(Uint32 mouse_id, mouse_button button, Uint8 clicks, Sint32 x, Sint32 y)
		+{abstract}  void mouse_button_released_event(Uint32 mouse_id, mouse_button button, Uint8 clicks, Sint32 x, Sint32 y)
	}
	...
	mouse_button_event_handler --> mouse_button
